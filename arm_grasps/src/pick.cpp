...
void pick(moveit::planning_interface::MoveGroup &group)
{
	...
	g.pre_grasp_posture.joint_names.resize(1, "finger_joint2");
	g.pre_grasp_posture.points.resize(1);
	g.pre_grasp_posture.points[0].positions.resize(1);
	g.pre_grasp_posture.points[0].positions[0] = 1;
	g.grasp_posture.joint_names.resize(1, "finger_joint2");
...
g.pre_place_approach.direction.header.frame_id = "gripper_roll_link";
g.pre_place_approach.min_distance = 0.1;
g.pre_place_approach.desired_distance = 0.2;
g.post_place_retreat.min_distance = 0.1;
g.post_place_retreat.desired_distance = 0.25;
g.post_place_posture.joint_names.resize(1, "finger_joint2");
...
ocm.link_name = "gripper_roll_link";
